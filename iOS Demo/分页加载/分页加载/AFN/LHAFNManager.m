...
@implementation LHAFNManager

+(void)GET:(NSString *)url params:(NSDictionary *)params
   success:(LHResponseSuccess)success fail:(LHResponseFail)fail{
    
    AFHTTPSessionManager *manager = [LHAFNManager managerWithBaseURL:nil sessionConfiguration:NO];
    [manager GET:url parameters:params progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        
        id dic = [LHAFNManager responseConfiguration:responseObject];
...
+(void)GET:(NSString *)url baseURL:(NSString *)baseUrl params:(NSDictionary *)params
   success:(LHResponseSuccess)success fail:(LHResponseFail)fail{
    ...
    AFHTTPSessionManager *manager = [LHAFNManager managerWithBaseURL:baseUrl sessionConfiguration:NO];
...
+(void)uploadWithURL:(NSString *)url
    ...
    AFHTTPSessionManager *manager = [LHAFNManager managerWithBaseURL:baseurl sessionConfiguration:YES];
